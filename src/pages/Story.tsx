      ...
      <RevealSection>
        <div className="section-inner">
          <div className="story-section">
            ...
            <p className="lead">למה כל מקומות הבילוי נראים <span className="highlight">אותו דבר?</span></p>
            <p>אותם שולחנות עץ "תעשייתיים", אותם כיסאות מתכת מהקטלוג, אותה תחושה שנעלמת בשנייה שיוצאים מהדלת. כולם רוצים להיות <span className="highlight-cyan">"המקום"</span> הבא בעיר, אבל בסוף נראים כמו עוד אחד ברשימה.</p>
            ...
            <p>הפרט שאנשים יושבים עליו שעות, נוגעים בו, חווים אותו באמת. וכשזה <span className="highlight-cyan">גנרי</span> גם הזיכרון מהמקום נשאר שטחי ולא באמת נתפס.</p>
